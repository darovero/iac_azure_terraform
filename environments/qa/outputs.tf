...
output "automation_account_names" {
  value = {
    for key, aa in module.automation_accounts :
    key => aa.automation_account_name
  }
}
...
output "automation_account_ids" {
  value = {
    for key, aa in module.automation_accounts :
    key => aa.automation_account_id
  }
}

output "automation_account_principal_ids" {
  value = {
    for key, aa in module.automation_accounts :
    key => aa.automation_account_principal_id
  }
}